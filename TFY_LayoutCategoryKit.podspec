Pod::Spec.new do |spec|
  ...
  spec.source_files  = "TFY_LayoutCategoryUtil/TFY_LayoutCategoryKit/*.h"
   ...
   spec.subspec 'TFY_Tools' do |ss|
     ...
     ss.subspec 'OpenShare' do |s|
      s.source_files  = "TFY_LayoutCategoryUtil/TFY_LayoutCategoryKit/TFY_Tools/OpenShare/**/*.{h,m}"
     end

     ss.subspec 'ModelSqlite' do |s|
      s.source_files  = "TFY_LayoutCategoryUtil/TFY_LayoutCategoryKit/TFY_Tools/ModelSqlite/**/*.{h,m}"
     end

   end

   spec.subspec 'TFY_SnapshotScroll' do |ss|
    ss.source_files  = "TFY_LayoutCategoryUtil/TFY_LayoutCategoryKit/TFY_SnapshotScroll/**/*.{h,m}"
   end
   ...
   spec.subspec 'TFY_Categories' do |ss|
      ...
      ss.subspec 'TFY_TagCollectionView' do |s|
        s.source_files  = "TFY_LayoutCategoryUtil/TFY_LayoutCategoryKit/TFY_Categories/TFY_TagCollectionView/**/*.{h,m}"
      end
