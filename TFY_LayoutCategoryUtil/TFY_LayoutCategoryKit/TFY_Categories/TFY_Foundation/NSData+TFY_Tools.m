...
@implementation NSData (TFY_Tools)
...
@end
#define TFY_DATA_ENCRYTION(encryptionType, clas)\
\
...
#define TFY_DATA_WITH_KEY(alg, key)\
\
...
- (NSData *)md2Data{
    ...
    TFY_DATA_ENCRYTION(MD2, 0)
    
}

- (NSString *)md2String{
    TFY_DATA_ENCRYTION(MD2, 1)
}
- (NSString *)md4String{
    TFY_DATA_ENCRYTION(MD4, 1)
}

- (NSData *)md4Data{
    TFY_DATA_ENCRYTION(MD4, 0)
}

- (NSString *)md5String{
    TFY_DATA_ENCRYTION(MD5, 1)
}

- (NSData *)md5Data{
    TFY_DATA_ENCRYTION(MD5, 0)
}

- (NSString *)sha1String{
    TFY_DATA_ENCRYTION(SHA1, 1)
}

- (NSData *)sha1Data{
    TFY_DATA_ENCRYTION(SHA1, 0)
}

- (NSString *)sha224String{
    TFY_DATA_ENCRYTION(SHA224, 1)
}

- (NSData *)sha224Data{
    TFY_DATA_ENCRYTION(SHA224, 0);
}

- (NSString *)sha256String{
    TFY_DATA_ENCRYTION(SHA256, 1);
}

- (NSData *)sha256Data{
    TFY_DATA_ENCRYTION(SHA256, 0);
}

- (NSString *)sha384String{
    TFY_DATA_ENCRYTION(SHA384, 1);
}

- (NSData *)sha384Data{
    TFY_DATA_ENCRYTION(SHA384, 0);
}

- (NSString *)sha512String{
    TFY_DATA_ENCRYTION(SHA512, 1);
}

- (NSData *)sha512Data{
    TFY_DATA_ENCRYTION(SHA512, 0);
}


- (NSString *)hmacMD5StringWithKey:(NSString *)key{
    TFY_DATA_WITH_KEY(MD5, key)
}
