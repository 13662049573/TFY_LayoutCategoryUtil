...
#define TFY_STRINGHASH(method)\
return [[self utf8Data] method];

#define TFY_STRINGHASH_KEY(method,key)\
return [[self utf8Data] hmac##method##StringWithKey:key];

@implementation NSString (Hash)
- (NSString *)md2String{
    TFY_STRINGHASH(md2String)
}

- (NSString *)md4String{
    TFY_STRINGHASH(md4String)
}

- (NSString *)md5String{
    TFY_STRINGHASH(md5String)
}

- (NSString *)sha1String{
    TFY_STRINGHASH(sha1String)
}

- (NSString *)sha224String{
    TFY_STRINGHASH(sha224String)
}

- (NSString *)sha256String{
    TFY_STRINGHASH(sha256String)
}

- (NSString *)sha384String{
    TFY_STRINGHASH(sha384String)
}
...
- (NSString *)hmacMD5StringWithKey:(NSString *)key{
    TFY_STRINGHASH_KEY(MD5,key)
}

- (NSString *)hmacSHA1StringWithKey:(NSString *)key{
    TFY_STRINGHASH_KEY(SHA1,key)
}

- (NSString *)hmacSHA224StringWithKey:(NSString *)key{
    TFY_STRINGHASH_KEY(SHA224,key)
}

- (NSString *)hmacSHA256StringWithKey:(NSString *)key{
    TFY_STRINGHASH_KEY(SHA256,key)
}

- (NSString *)hmacSHA384StringWithKey:(NSString *)key{
    TFY_STRINGHASH_KEY(SHA384,key)
}

- (NSString *)hmacSHA512StringWithKey:(NSString *)key{
    TFY_STRINGHASH_KEY(SHA512,key)
}
@end
