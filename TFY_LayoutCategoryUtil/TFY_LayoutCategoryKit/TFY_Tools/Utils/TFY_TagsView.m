...
@implementation __InputTextField
- (void)deleteBackward {
...
- (void)commonSetup {
  ...
  _tagButtonHeight = TagsViewAutomaticDimension;
  _textFieldHeight = TagsViewAutomaticDimension;
...
- (void)layoutSubviews {
  ...
  for (UIButton *button in self.mutableTagButtons) {
    ...
    if (self.tagButtonHeight > TagsViewAutomaticDimension) {
  ...
  if (self.editable) {
    ...
    if (self.textFieldHeight > TagsViewAutomaticDimension) {
...
- (void)setTextFieldAlign:(TagsViewTextFieldAlign)textFieldAlign {
